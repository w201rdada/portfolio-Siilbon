...
The end result will be a graphical interface that shows an operator only the 5-10 most important issues that they need to correct ranked by importance.  It will also offer options for the operator to override the predicted importance to provide live feedback.  Rather than a large table of alarms the interface will allow for quick navigation to top 5-10 issues while also providing some summary bar graphs to illustrate whether the issues are isolated to a single area, or plantwide[@tufte2009].  The interface will adapt to the current user to compensate for their lack of experience.  To shorten the onboarding process, a common low experience account would serve as a baseline before it customized to a new employee.  
